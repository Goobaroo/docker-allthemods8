# [All the Mods 8-1.0.28](https://www.curseforge.com/minecraft/modpacks/all-the-mods-8) on Curseforge
...
The docker on first run will download the same version as tagged of All the Mods 8-1.0.28 and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
