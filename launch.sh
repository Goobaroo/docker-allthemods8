...
if ! [[ -f 'Server-Files-1.0.28.zip' ]]; then
	rm -fr defaultconfigs config kubejs libraries mods Simple.zip forge*
	curl -Lo 'Server-Files-1.0.28.zip' 'https://edge.forgecdn.net/files/4787/500/Server-Files-1.0.28.zip' || exit 9
	unzip -u -o 'Server-Files-1.0.28.zip' -d /data
